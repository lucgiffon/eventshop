...
<table class="table table-striped datatables" data-responsive="true" data-order="{{ json_encode($order) }}" data-url="{{ $url }}" data-attributes="{{ json_encode($attributes, JSON_FORCE_OBJECT) }}">
	<thead>
		<tr>
