...
class DisplayDatatables extends DisplayTable
{
	...
	public function initialize()
	{
		...
		AssetManager::addScript('https://cdn.datatables.net/responsive/2.0.0/js/dataTables.responsive.min.js');
		...
		AssetManager::addStyle('https://cdn.datatables.net/responsive/2.0.0/css/responsive.dataTables.min.css');
	}
